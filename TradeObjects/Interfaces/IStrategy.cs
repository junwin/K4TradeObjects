...
namespace KaiTrade.Interfaces
{
   ...
   /// <param name="strategy"></param>
    ...
    public interface IStrategy
    {
        ...
        /// <summary>
        /// Defines the name of some condition that can be used
        /// to enter the strategy - note it is recommended to use
        /// a trade signal
        /// </summary>
        ...
        /// <summary>
        /// Defines the name of some condition that can be used
        /// to exit the strategy - note it is recommended to use
        /// a trade signal
        /// </summary>
        ...
        /// trigger names to constions in the trade venue - not all venues support this
        /// </summary>
        bool AutoConnectTrg
        { get; set; }
