...
namespace K2DataObjects
{
    ...
    //[System.Data.Linq.Mapping.TableAttribute(Name = "dbo.UserTrial")]
    public class UserTrial
    {
        ...
        [DataMember]
        [JsonProperty]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[ID]", Storage = "m_UserID", DbType = "NVarChar(36) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
