...
namespace K2DataObjects
{
    ...
    //[System.Data.Linq.Mapping.TableAttribute(Name = "dbo.Product")]
    public class Product : KaiTrade.Interfaces.IProduct
    {
        ...
        private decimal? maintainenceMargin;
        ...
        [DataMember]
        [JsonProperty]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[Mnemonic]", Storage = "m_Mnemonic", DbType = "NVarChar(255) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
        ...
        [JsonProperty]
        //[System.Data.Linq.Mapping.Column]
        public decimal? MaintainenceMargin
        {
            get { return maintainenceMargin; }
            set { maintainenceMargin = value; }
        }
        ...
        #endregion TradableProduct Members
