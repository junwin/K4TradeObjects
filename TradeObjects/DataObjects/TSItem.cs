...
namespace K2DataObjects
{
    ...
    public class TSItem : KaiTrade.Interfaces.ITSItem
    {
        ...
        private KaiTrade.Interfaces.TSItemType m_ItemType = KaiTrade.Interfaces.TSItemType.none;

        private KaiTrade.Interfaces.TSItemSourceActionType m_SourceActionType = KaiTrade.Interfaces.TSItemSourceActionType.none;
