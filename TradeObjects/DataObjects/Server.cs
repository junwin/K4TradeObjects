...
{
    [DataContract]
    //[System.Data.Linq.Mapping.TableAttribute(Name = "dbo.Server")]
    public class Server :KaiTrade.Interfaces.IServer
    {
        ...
        [DataMember]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[ID]", Storage = "m_ID", DbType = "NVarChar(36) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
        public string ID
        {
            get { return m_ID; }
            set { m_ID = value; }
