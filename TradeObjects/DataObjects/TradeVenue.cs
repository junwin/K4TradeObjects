...
namespace K2DataObjects
{
    ...
    //[System.Data.Linq.Mapping.TableAttribute(Name = "dbo.Venue")]
    public class TradeVenue : KaiTrade.Interfaces.IVenue
    {
        ...
        [DataMember]
        [JsonProperty]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[Code]", Storage = "m_Code", DbType = "NVarChar(256) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
        public string Code
        {
            get
            {
