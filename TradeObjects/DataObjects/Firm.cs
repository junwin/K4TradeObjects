...
namespace K2DataObjects
{
    ...
    //[System.Data.Linq.Mapping.TableAttribute(Name = "dbo.Firm")]
    public class Firm : KaiTrade.Interfaces.IFirm
    {
        ...
        [DataMember]
        [JsonProperty]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[FirmCode]", Storage = "m_FirmCode", DbType = "NVarChar(256) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
