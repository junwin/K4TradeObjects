...
namespace K2DataObjects
{
    ...
    //[System.Data.Linq.Mapping.TableAttribute(Name = "dbo.User")]
    public class User : KaiTrade.Interfaces.IUser
    {
        ...
        [DataMember]
        [JsonProperty]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[ID]", Storage = "m_Identity", DbType = "NVarChar(36) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
        public string ID
        {
            get
            {
        ...
        [DataMember]
        [JsonProperty]
        //[System.Data.Linq.Mapping.ColumnAttribute(Name = "[LastSignIn]", Storage = "m_LastSignIn", DbType = "DateTime", CanBeNull = true, IsPrimaryKey = false)]
